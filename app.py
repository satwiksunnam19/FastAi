...
title = "Cat v Dog Classifier"
description = "A cat v Dog classifier trained on the Oxford Pets dataset with fastai. Created as a demo for Gradio and HuggingFace Spaces."
examples = ['FastAi/images.jpeg']
